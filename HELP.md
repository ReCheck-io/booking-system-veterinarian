...
* The original package name 'io.recheck.qa.jobs-app.booking-vet.rest-service' is invalid and this project uses 'io.recheck.qa.jobsapp.bookingvet.restservice' instead.
